...
const Header = () => {
    ...
    const addFechas = () => {
        ...
        if (rentCalendar[0] !== null && rentCalendar[1] !== null) {
            const stringFechas = format(rentCalendar[0], 'dd MMM.') + " - " + format(rentCalendar[1], 'dd MMM.') + adicional_dates
            ...
            <header className="header">
                ...
                >
                    <Popover.Target>
                        ...
                        >
                            <SearchBar first='En cualquier lugar del mundo' second={`${fechas}`} third={`${totalPerson}`} />
                        </button>
                    </Popover.Target>
